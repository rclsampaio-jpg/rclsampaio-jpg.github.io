    ...
    <div className="flex flex-col lg:flex-row min-h-[80vh] bg-slate-50 dark:bg-ink-raised/45 rounded-3xl overflow-hidden border border-rose-100/30 dark:border-rosegold/10 font-sans shadow-lg">
      ...
      <aside className="w-full lg:w-64 bg-white dark:bg-ink-raised p-6 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-rose-150/20 dark:border-rosegold/10">
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2 text-xs font-medium rounded-xl transition-all ${
                activeModule === 'dashboard'
                  ...
                  : 'text-slate-600 hover:bg-rose-50/50 dark:text-ink-muted dark:hover:bg-rosegold/5'
              }`}
            >
        ...
        <div className="pt-6 border-t border-rose-100/20 mt-6 space-y-3">
          <div className="flex items-center justify-between text-[10px] text-slate-400 dark:text-ink-muted font-mono">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-white dark:bg-ink-raised p-5 rounded-2xl border border-rose-100/20 dark:border-rosegold/10 shadow-xs">
                <div className="flex justify-between items-center text-slate-400 dark:text-ink-muted mb-2">
                    ...
                    >
                      <div className="space-y-1">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-[10px] font-mono text-slate-400 dark:text-ink-muted">ID: {j.id}</span>
                        </div>
                        <h4 className="text-base font-serif font-black uppercase text-slate-800 dark:text-white">
                          {j.title.pt}
                        </h4>
                        <p className="text-xs text-slate-500 dark:text-ink-muted line-clamp-2 leading-relaxed">
                          {j.subtitle.pt}
                        </p>
                      </div>

                      <div className="flex items-center justify-between border-t border-rose-100/10 pt-3">
                        <div className="flex gap-4 text-[10px] text-slate-400 dark:text-ink-muted">
                        ...
                        <div className="flex gap-1.5">
                          ...
                          <button
                            ...
                            className="p-1.5 bg-slate-100 dark:bg-warmbrown text-slate-600 dark:text-ink-muted rounded-lg hover:bg-rosegold/10 hover:text-rosegold transition"
                            title="Duplicar"
                          >
                ...
                <button
                  ...
                  className={`px-4 py-2 text-xs font-sans rounded-xl border transition-all ${
                    selectedJourneyId === j.id
                      ...
                      : 'bg-white dark:bg-warmbrown border-rose-100/25 dark:border-rosegold/10 text-slate-600 dark:text-ink-muted'
                  }`}
                >
                  {j.title.pt}
                </button>
                    ...
                    <div className="bg-white dark:bg-ink-raised border border-rose-100/25 dark:border-rosegold/10 rounded-2xl p-6 flex flex-col md:flex-row justify-between gap-6">
                      <div className="flex gap-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-xs text-slate-500 dark:text-ink-muted max-w-xl">
                            {activeJ.subtitle.pt}
                          </p>
                      ...
                      <div className="flex flex-row md:flex-col justify-end gap-2 shrink-0">
                        <button
                          ...
                          className="px-4 py-2 bg-slate-100 dark:bg-warmbrown text-slate-700 dark:text-ink-muted text-xs font-bold rounded-xl flex items-center gap-1 hover:bg-rosegold/10 hover:text-rosegold transition-all"
                        >
                                ...
                                <div className="bg-[#FAF8F5]/60 dark:bg-warmbrown-light/10 p-4 border-b border-rose-100/10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-[11px] text-slate-400 dark:text-ink-muted font-sans italic">
                                  ...
                                  <div className="flex gap-1">
                                    ...
                                    <button
                                      ...
                                      className="p-1.5 bg-slate-100 dark:bg-warmbrown text-slate-600 dark:text-ink-muted rounded-lg hover:text-rosegold hover:bg-rosegold/10 transition"
                                      ...
                                      {chDays.map(day => (
                                        ...
                                        >
                                          <div>
                                            ...
                                            <p className="text-[10px] text-slate-400 dark:text-ink-muted line-clamp-1 italic mt-0.5">
                                              {day.hook.pt}
                                            </p>
                                          </div>
                                          ...
                                          <div className="flex justify-end gap-1 border-t border-rose-100/5 pt-2">
                                            <button
                                              ...
                                              className="p-1 text-slate-500 dark:text-ink-muted hover:text-rosegold transition"
                                              title="Editar Lição"
                                            >
                                              <Edit className="h-3 w-3" />
                                            </button>
            ...
            {editingJourney && (
              <div className="bg-white dark:bg-ink-raised rounded-2xl border border-rose-100/25 dark:border-rosegold/10 p-6 space-y-6">
                ...
                <div className="flex justify-end gap-2 pt-4 border-t border-rose-100/10">
                  <button
                    onClick={() => setEditingJourney(null)}
                    className="px-4 py-2 bg-slate-100 dark:bg-warmbrown text-slate-700 dark:text-ink-muted rounded-xl text-xs font-bold"
                  >
                    Cancelar
                  </button>
                  <button
