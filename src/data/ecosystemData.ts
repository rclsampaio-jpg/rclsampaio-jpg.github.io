...
export const DEFAULT_COMMUNITY_CONFIG: CommunityConfig = {
  ...
  joinLink: 'https://pay.kiwify.com.br/omhzNz3',
  buttonColor: '#A35D68',
  image: '',
  platform: 'Kiwify'
};
...
export const INITIAL_LIBRARY_ASSETS: LibraryAsset[] = [
  ...
  },
  {
    ...
    description: {
      pt: 'Os 11 prompts prontos pra pedir conteúdo direto pra Renata OS: cole o tema entre colchetes e mande, ela entrega o conteúdo pronto.',
      en: 'The 11 ready-made prompts to request content directly from Renata OS: fill in the topic and send, she delivers the finished content.',
      es: 'Los 11 prompts listos para pedir contenido directo a Renata OS: completa el tema entre corchetes y envíalo, ella entrega el contenido listo.'
    },
    category: 'pdfs',
...
const ECOSYSTEM_CONFIG_VERSION = '18';
