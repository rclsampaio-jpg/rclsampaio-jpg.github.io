...
export const PRACTICE_WEEKS: PracticeWeek[] = [
  {
    ...
    dailyMessages: [
      ...
      'Grava hoje a sua história de prova, antes de decidir se ela ficou boa o suficiente. Se vier com desculpa antes do resultado, tira a desculpa e deixa só o resultado. Ex: troca "não sei se isso vai fazer diferença, mas..." por ir direto no resultado.',
  ...
  },
  {
    ...
    dailyMessages: [
      ...
      'Grava o ângulo Números hoje: "Depois de [resultado real] em [tempo], aqui está o que eu queria ter sabido antes." Só com número que aconteceu de verdade.',
  ...
  },
  {
    ...
    dailyMessages: [
      ...
      'Reescuta o que você gravou ontem pensando nela. Ainda parece que você tá falando com uma sala cheia, ou já parece uma conversa só com ela?',
  ...
  },
  {
    ...
    challenge: 'Ninguém enxerga o próprio crescimento só de dentro, às vezes precisa reler as provas. Essa semana, bora revisar as suas!\n\nAntes de gravar essa semana, abre os links que você salvou nas semanas 31 a 50. Reveja o que você mostrou de prova, de ângulos e de resposta a dúvida. Grava contando o que mudou em você entre o primeiro link e o último.',
    ...
    dailyMessages: [
      'Essa semana começa revisando, não gravando ainda. Abre os links que você salvou nas semanas 31 a 50.',
      'Compara o link mais antigo dessas semanas com o mais recente. O que já não soa igual?',
      'Agora sim: grava contando o que mudou em você desde a semana de Prova de Resultado, lá no dia 31, com o que você revisou nos últimos dois dias.',
      'Escolhe um dos três exercícios anteriores (prova, ângulos, dúvida) e grava a versão 2.0 dele.',
  ...
  },
  {
    ...
    challenge: 'Sentir que já tá pronta e ter prova de que já tá pronta são coisas diferentes. Bora descobrir qual das duas é a sua essa semana?!\n\nRevê os links das semanas 51 a 70. Depois responde, com sinceridade: alguém que te acompanha já te mandou mensagem por conta própria? Você já sabe responder quando alguém duvida do que você fala ou oferece? Se sentir que já construiu isso, o Destrave tá logo ali em Próximo Nível.',
    ...
    dailyMessages: [
      ...
      'Grava: você já sabe responder a dúvida ou objeção que mais aparece pra você? Testa ela em voz alta agora. Ex: "é caro", "não tenho tempo agora", "isso funciona mesmo pro meu caso?".',
