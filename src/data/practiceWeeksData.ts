...
// inteira, de propósito, é repetição que constrói prática de verdade, não
// uma tarefa nova por dia). Sem isso, os 7 dias da mesma semana pareciam
// abandono: tela idêntica o tempo todo. Indexado 0=segunda..6=domingo,
// mesma convenção de getWeekdayPosition (templateData.ts). Ela já passou
// dos 30 dias de "push pra aparecer", por isso o tom aqui é direcionamento
// e autoridade, não motivação de empurrãozinho.
export const PRACTICE_DAILY_MESSAGES: string[] = [
  ...
  'Metade da semana. Se o que saiu até aqui ainda parece com o começo da sua jornada, muda o ângulo hoje em vez de repetir o mesmo formato.',
  'Você não precisa mais de lembrete pra aparecer. Precisa decidir o que essa semana te ensinou sobre como você quer ser vista.',
  'Fecha a semana olhando pro que ela revelou sobre você, não só pro que você postou.',
  'Hoje não é sobre quantidade. É sobre revisar o que já ficou bom o suficiente pra usar depois, sem regravar tudo de novo.',
  'Semana que vem o tema muda. O que você construiu nessa continua valendo, não some.'
];

// "Onde te apoiar" também variando por dia, amarrado ao que a mensagem
// daquele dia pede (terça pede comparação -> aponta pros links salvos;
// quarta pede mudar ângulo -> aponta pro prompt de ângulos; etc), em vez
// de ficar estático a semana inteira igual o resto do card já era.
